...
$modulePsd1 = Get-Item -Path (Join-Path $PSScriptRoot 'Azs.Azurebridge.Admin.psd1')
$modulePath = $modulePsd1.FullName
$moduleName = $modulePsd1.BaseName

# Load DLL to use build-time cmdlets
Import-Module -Name $modulePath
Import-Module -Name (Join-Path $PSScriptRoot './bin/Azs.Azurebridge.Admin.private.dll')
