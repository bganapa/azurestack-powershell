...
# Changes may cause incorrect behavior and will be lost if the code is regenerated.
  ...
  $null = Import-Module -Name (Join-Path $PSScriptRoot './bin/Azs.Azurebridge.Admin.private.dll')

  # Get the private module's instance
  $instance = [Microsoft.Azure.PowerShell.Cmdlets.BridgeAdmin.Module]::Instance
  ...
  $customModulePath = Join-Path $PSScriptRoot './custom/Azs.Azurebridge.Admin.custom.psm1'
