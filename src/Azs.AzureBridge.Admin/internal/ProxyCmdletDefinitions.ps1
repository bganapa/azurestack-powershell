...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'Azs.Azurebridge.Admin.private\Remove-AzsAzureBridgeDownloadedProduct_Delete';
            DeleteViaIdentity = 'Azs.Azurebridge.Admin.private\Remove-AzsAzureBridgeDownloadedProduct_DeleteViaIdentity';
        }
