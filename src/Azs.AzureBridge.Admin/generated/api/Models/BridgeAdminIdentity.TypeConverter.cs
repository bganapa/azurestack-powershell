...
namespace Microsoft.Azure.PowerShell.Cmdlets.BridgeAdmin.Models
{
    ...
    /// <summary>
    /// A PowerShell PSTypeConverter to support converting to an instance of <see cref="BridgeAdminIdentity" />
    /// </summary>
    public partial class BridgeAdminIdentityTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// parameter.
        /// </summary>
        /// <param name="sourceValue">the <see cref="System.Object" /> instance to check if it can be converted to the <see cref="BridgeAdminIdentity"
        /// /> type.</param>
        /// <returns>
        /// <c>true</c> if the instance could be converted to a <see cref="BridgeAdminIdentity" /> type, otherwise <c>false</c>
        /// </returns>
        ...
        /// <returns>
        /// an instance of <see cref="BridgeAdminIdentity" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        ...
        /// /> and <see cref="ignoreCase" />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="BridgeAdminIdentity" />.</param>
        /// <returns>
        /// an instance of <see cref="BridgeAdminIdentity" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.BridgeAdmin.Models.IBridgeAdminIdentity ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            if (type == typeof(global::System.String))
            {
                return new BridgeAdminIdentity { Id = sourceValue };
            }
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.BridgeAdmin.Models.IBridgeAdminIdentity).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
            {
                return BridgeAdminIdentity.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());;
            }
            catch
            {
            ...
            if (typeof(global::System.Management.Automation.PSObject).IsAssignableFrom(type))
            {
                return BridgeAdminIdentity.DeserializeFromPSObject(sourceValue);
            }
            if (typeof(global::System.Collections.IDictionary).IsAssignableFrom(type))
            {
                return BridgeAdminIdentity.DeserializeFromDictionary(sourceValue);
            }
            return null;
        }
