...
namespace Microsoft.Azure.PowerShell.Cmdlets.BridgeAdmin.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.BridgeAdmin.Support.ProvisioningState Downloading = @"Downloading";

        public static Microsoft.Azure.PowerShell.Cmdlets.BridgeAdmin.Support.ProvisioningState Running = @"Running";

        public static Microsoft.Azure.PowerShell.Cmdlets.BridgeAdmin.Support.ProvisioningState Starting = @"Starting";

        public static Microsoft.Azure.PowerShell.Cmdlets.BridgeAdmin.Support.ProvisioningState Stopped = @"Stopped";

        public static Microsoft.Azure.PowerShell.Cmdlets.BridgeAdmin.Support.ProvisioningState Stopping = @"Stopping";

        public static Microsoft.Azure.PowerShell.Cmdlets.BridgeAdmin.Support.ProvisioningState Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.BridgeAdmin.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.BridgeAdmin.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.BridgeAdmin.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.BridgeAdmin.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
