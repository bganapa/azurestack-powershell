...
namespace Microsoft.Azure.PowerShell.Cmdlets.BridgeAdmin.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.BridgeAdmin.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.BridgeAdmin.Support";
    private const string PropertiesExcludedForTableview = @"Id";
