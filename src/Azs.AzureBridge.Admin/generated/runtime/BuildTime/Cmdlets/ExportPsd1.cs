...
using static Microsoft.Azure.PowerShell.Cmdlets.BridgeAdmin.Runtime.PowerShell.PsHelpers;
    ...
    public class ExportPsd1 : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            try
            {
                ...
                sb.AppendLine($@"{Indent}RootModule = '{"Azs.Azurebridge.Admin.psm1"}'");
                ...
                sb.AppendLine($@"{Indent}Description = '{"Microsoft AzureStack PowerShell: AzureBridge Admin cmdlets"}'");
                ...
                else
                {
                    ...
                    var formatList = customFormatPs1xmlFiles.Prepend("./Azs.Azurebridge.Admin.format.ps1xml").ToPsList();
                ...
                sb.AppendLine($@"{Indent}{Indent}{Indent}Tags = {"AzureStack ResourceManager ARM PSModule".Split(' ').ToPsList().NullIfEmpty() ?? "''"}");
                sb.AppendLine($@"{Indent}{Indent}{Indent}LicenseUri = '{"https://aka.ms/azps-license"}'");
                sb.AppendLine($@"{Indent}{Indent}{Indent}ProjectUri = '{"https://github.com/Azure/azurestack-powershell"}'");
                sb.AppendLine($@"{Indent}{Indent}{Indent}ReleaseNotes = 'AzureStack Hub Admin module generated with https://github.com/Azure/autorest.powershell'");
                var profilesList = "";
